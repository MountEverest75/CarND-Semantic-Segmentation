...
def load_vgg(sess, vgg_path):
    ...
    return input_layer, keep_prob, layer3_output, layer4_output, layer7_output
...
def layers(vgg_layer3_out, vgg_layer4_out, vgg_layer7_out, num_classes):
    ...
    # Keep padding='same' to keep the same exact size
    ...
    # upsample
    layer4_conv_t = tf.layers.conv2d_transpose(layer7_conv_1x1, num_classes, 4,
                                             strides= (2, 2),
                                             padding= 'same',
                                             kernel_initializer= tf.random_normal_initializer(stddev=0.01),
                                             kernel_regularizer= tf.contrib.layers.l2_regularizer(1e-3))
    ...
    layer4_out = tf.add(layer4_conv_t, layer4_conv)
    # upsample
    layer3_conv_t = tf.layers.conv2d_transpose(layer4_out, num_classes, 4,
                                             strides= (2, 2),
                                             padding= 'same',
                                             kernel_initializer= tf.random_normal_initializer(stddev=0.01),
                                             kernel_regularizer= tf.contrib.layers.l2_regularizer(1e-3))
    ...
    layer3_conv = tf.layers.conv2d(vgg_layer3_out, num_classes, 1,
                                   ...
                                   kernel_regularizer= tf.contrib.layers.l2_regularizer(1e-3))
    # skip connection (element-wise addition)
    layer3_out = tf.add(layer3_conv_t, layer3_conv)
    # upsample
